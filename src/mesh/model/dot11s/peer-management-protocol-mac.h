...
public:
   ...
   */
  Ptr<MeshWifiInterfaceMac> GetParent ();
  /**
  ...
  /**
   * Update the failAvg of the link between local and Peer Interface on the parent MeshWifiInterfaceMac object
  ...
  // \}
  /*
   * Get the Wifi Mode for the Link to a specific peerAddress
   * \param peerAddress, the peer Address
   */
